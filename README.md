```
How's it going? I'm a Spanish student, and I enjoy creating code and task automation scripts from time to time. I used
to code in C a while ago, then I did some HTML and CSS, as well as BATCH, Bash and VBS. I stuck with Python, my big
favourite. Every day I learn something new that expands my knowledge. I am studying to obtain the eJPTv2 cybersecurity
certificate. Curiosity is one of my virtues; I always want to learn something new. Sometimes I reuse other people's code
to implement it in my own (always crediting the creator), and that enriches my programmes. I will work in cybersecurity,
